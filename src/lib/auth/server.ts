...
const CUSTOM_APP_ORIGINS: string[] = [
  "https://ptakhozvit.com.ua",
  "https://www.ptakhozvit.com.ua",
  "https://agronom2008.grok.me",
];
const APP_HOSTS = ["ptakhozvit.com.ua", "www.ptakhozvit.com.ua", "agronom2008.grok.me"];
const baseURL = {
  allowedHosts: [...APP_HOSTS, ...previewAllowedHosts, "localhost", "127.0.0.1", "[::1]"],
  protocol: "auto" as const,
  fallback: explicitBaseURL ?? "https://agronom2008.grok.me",
};

// Origins Better Auth accepts on credentialed POSTs (sign-up/sign-in, etc.).
// Missing entries here surface as FORBIDDEN "Invalid origin".
const trustedOrigins: string[] = explicitBaseURL
  ? [explicitBaseURL, ...CUSTOM_APP_ORIGINS, ...LOCAL_DEV_ORIGINS]
  : [
